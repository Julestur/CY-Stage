...
<head>
    ...
    <meta name="description" content="Félicitation ! Vous êtes officiellement inscrit sur le portail !">
...
<div class="page-dimension">
    <div class="contenu-principal">  
        ...
        <div class="contenu-centre">
            ...
            <p class="texte_aff"><?php echo "Bienvenue ".htmlspecialchars($form["prenom"]) . " !" ?> Vous pouvez maintenant vous connecter !</p>
            <script src="./js/confetti.js"></script>
            
            <div class = "boutonTaille2">
            <p><a href="connexion.php"><input type="button" value="Se connecter" id="bouton-style-connexion"></a></p>
            </div>
